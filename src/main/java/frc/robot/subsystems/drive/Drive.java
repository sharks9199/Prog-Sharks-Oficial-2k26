    ...
    public void periodic() {
      ...
      for (int i = 0; i < sampleCount; i++) {
        ...
        if (gyroInputs.connected) {
          ...
          // --- CORREÇÃO: Inverte o sinal do Pigeon (unaryMinus) ---
        ...
        // --- REMOVIDO: A lógica de visão não deve ficar aqui dentro.
        // O Drive não deve depender da Vision diretamente para evitar acoplamento.
        // A atualização da pose pela visão acontece no RobotContainer.
      }
