...
public class ModuleIOComp implements ModuleIO {
  ...
  // --- ADICIONADO ---
  // Requisições de Motion Magic
  private final MotionMagicVoltage turnMotionMagicRequest = new MotionMagicVoltage(0);
  private final MotionMagicVoltage driveMotionMagicRequest = new MotionMagicVoltage(0);
  ...
  public void setTurnPosition(Rotation2d rotation) {
    // Usa a requisição de Motion Magic que criamos
    // .withSlot(0) diz para usar os ganhos PID e configs de Motion Magic do Slot 0
    turnTalon.setControl(positionVoltageRequest
        .withPosition(rotation.getRotations())
        .withSlot(0)); // Usa os ganhos do Slot 0 gerados pelo Tuner X
  }
}
