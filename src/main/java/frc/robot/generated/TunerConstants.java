...
public class TunerConstants {
    ...
    private static final Slot0Configs driveGains = new Slot0Configs().withKP(0.2).withKI(0).withKD(0.08).withKS(0.24)
            .withKV(0.12);
    ...
    private static final double kCoupleRatio = 25.0 / 7.0;
